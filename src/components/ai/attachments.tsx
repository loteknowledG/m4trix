...
export const AttachmentInfo = ({ showMediaType = false, className, ...props }: AttachmentInfoProps) => {
  ...
  return (
    <div className={cn("min-w-0 flex-1", className)} {...props}>
      ...
      {showMediaType && data.mediaType && <span className="block truncate text-muted-foreground text-xs">{data.mediaType}</span>}
    </div>
  )
}
...
export default function AttachmentsDemo() {
  const imageAttachments: AttachmentData[] = [
    { id: "1", type: "file", filename: "photo-1.jpg", mediaType: "image/jpeg", url: "https://picsum.photos/seed/attach1/200/200" },
    { id: "2", type: "file", filename: "photo-2.jpg", mediaType: "image/jpeg", url: "https://picsum.photos/seed/attach2/200/200" },
    { id: "3", type: "file", filename: "landscape.png", mediaType: "image/png", url: "https://picsum.photos/seed/attach3/200/200" },
  ]
